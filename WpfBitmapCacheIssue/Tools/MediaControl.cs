...
namespace Microsoft.Windows.Media
{
    ...
    // Token: 0x02000060 RID: 77
    public class SelectProcessArgs : EventArgs
    {
        // Token: 0x170000A4 RID: 164
        // (get) Token: 0x0600030A RID: 778 RVA: 0x0000C45E File Offset: 0x0000B45E
        // (set) Token: 0x0600030B RID: 779 RVA: 0x0000C466 File Offset: 0x0000B466
        public ClrVersion ClrVersion { get; private set; }

        // Token: 0x170000A5 RID: 165
        // (get) Token: 0x0600030C RID: 780 RVA: 0x0000C46F File Offset: 0x0000B46F
        // (set) Token: 0x0600030D RID: 781 RVA: 0x0000C477 File Offset: 0x0000B477
        public Process Process { get; private set; }

        // Token: 0x0600030E RID: 782 RVA: 0x0000C480 File Offset: 0x0000B480
        public SelectProcessArgs(Process process, ClrVersion clrVersion)
        {
    ...
    public class MediaControl
	{
		...
		private MediaControl(int processId, ClrVersion clrVersion)
		{
			...
			case ClrVersion.V4:
                    ...
                    {
                        Console.WriteLine($" > Attaching to {sectionName2}");
                        this.ConnectSharedMemorySection(sectionName2);
                        return;
                    }
					Console.WriteLine($" > Cannot Attach to Internal");
                    return;
			default:
				return;
			}
		...
		{
			Console.WriteLine($"Connecting to Shared Memory '{sectionName}'...");
